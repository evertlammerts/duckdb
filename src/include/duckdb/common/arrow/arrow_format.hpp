...
public:
	static constexpr const ResultUnitType TYPE = ResultUnitType::ARROW;

public:
	DUCKDB_API ArrowUnit();
...
//! Append, IsFull and Finish run concurrently on worker threads that share this object and the global
